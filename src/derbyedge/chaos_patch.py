...
This module is RACE-FAMILY scoped: activates on Derby-family races
(3yo G1 dirt routes, field ≥ 14, ChaosIndex ≥ 0.7) by default, but
accepts an explicit override via chaos_index parameter.
"""
...
MULT_FAV_RAIL_CLOSER  = 0.90
MULT_FAV_TACT_INNER   = 0.95
MULT_FAV_TACT_OUTER   = 1.05
...
def apply_derby_chaos_patch(
    ...
    df['WinProb_base'] = df['WinProb_base'] / base_total
